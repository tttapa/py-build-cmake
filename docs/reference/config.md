...
| <a id="conan.cmake.shared"></a> `shared` | Enable compilation in shared mode and modify the generated wheel to self-contain the needed dynamic libraries. | bool | `false` |
| <a id="conan.cmake.requirements"></a> `requirements` | List of Conan requirements in case you don't want to have a conanfile. <br/>For example: `requirements = ["pybind11/3.0.1", "fmt/12.0.0"]` | list+ | `[]` |
