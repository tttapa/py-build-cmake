...
| `generated` | Do not try to locate the module in the source directory, but assume that it is generated by CMake. Dynamic metadata cannot be used when set. | `'module'` \| `'package'` | `none` |
