...
macro(find_swig_python_first)
    ...
    if (NOT USE_GLOBAL_SWIG)
        set(host_interp ${CMAKE_CROSSCOMPILING_EMULATOR} ${Python_EXECUTABLE})
        foreach(interp "${host_interp}" "${PY_BUILD_CMAKE_BUILD_PYTHON_INTERPRETER}")
            if (NOT SWIG_EXECUTABLE OR NOT EXISTS ${SWIG_EXECUTABLE})
                message(STATUS "Detecting SWIG location (${interp})")
                ...
                execute_process(COMMAND ${interp} -c
