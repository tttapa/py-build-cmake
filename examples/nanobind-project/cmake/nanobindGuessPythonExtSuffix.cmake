...
function(nanobind_guess_python_module_extension python)
  ...
  if(NOT DEFINED PYTHON_MODULE_EXT_SUFFIX)
    unset(NB_SUFFIX PARENT_SCOPE)
    unset(NB_SUFFIX_S PARENT_SCOPE)
    return()
  endif()
  ...
  get_filename_component(_PYTHON_MODULE_EXTENSION_EXT "${PYTHON_MODULE_EXT_SUFFIX}" LAST_EXT)
  ...
  # Return results
  set(NB_SUFFIX
      "${_PYTHON_MODULE_DEBUG_POSTFIX}${_PYTHON_MODULE_EXTENSION}"
      PARENT_SCOPE)
  set(NB_SUFFIX_S
      ".abi3${_PYTHON_MODULE_EXTENSION_EXT}"
      PARENT_SCOPE)
